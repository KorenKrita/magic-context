...
export function createTodowriteTool(): ToolDefinition<any> {
	return ({
		name: TODO_TOOL_NAME,
		label: "Todos",
		description: "Manage the session task list.",
		promptSnippet: PROMPT_SNIPPET as any,
		promptGuidelines: PROMPT_GUIDELINES as any,
		...
		renderResult(result, _opts, theme: any) {
